...
@section('content')
    ...
    <div class="container mt-5 d-flex justify-content-center flex-column  align-items-center">
        <div class="privateDining-header">
            <h1 class="text-center fw-bold" style="text-transform: uppercase">Gericht</h1>
        </div>
        <div class="privateDining-logo mt-1 mb-3">
            <img src="{{asset('img')}}/MainLogo.png" style="width: 75px; height: 75px;" alt="">
        </div>
        <div class="privateDining-content">
            <p class="text-center" style="font-size: 15px; line-height: 28px; margin: 0 5%;">
    ...
    <div class="container mt-5 mb-5">
        <div class="row mb-5 privateDining2">
            <div class="col-md-6 mt-2 privateDining2-img">
                <img src="{{asset('img')}}/private-dining-6.jpg" alt="">
            </div>
            <div class="col-md-6 d-flex justify-content-center flex-column mt-2">
                <div class="privateDining2-header">
                    <h3 class="fw-bold">Japanese Table | From 6 To 12 Guests</h3>
                </div>
                <div class="privateDining2-content mt-3">
                    <h5 class="mb-3" style="font-size: 15px;">Impressive Japanese themed dining room, and a peaceful atmosphere</h5>
                    <h5 style="font-size: 15px; line-height: 30px;">
                ...
                <div class="privateDining2-bottom">
                    <button class="btn btn-orange text-white mt-3">Request Proposal</button>
                </div>
            </div>
        </div>
        <div class="row privateDining2">
            <div class="col-md-6 mt-2 privateDining2-img">
                <img src="{{asset('img')}}/private-dinning-16.jpg" alt="">
            </div>
            <div class="col-md-6 d-flex justify-content-center flex-column mt-2">
                <div class="privateDining2-header">
                    <h3 class="fw-bold">Chinese Table | From 12 To 20 Guests</h3>
                </div>
                <div class="privateDining2-content mt-3">
                    <h5 class="mb-3" style="font-size: 15px;">A Chinese-themed dining room that seems luxurious and a modern atmosphere</h5>
                    <h5 style="font-size: 15px; line-height: 30px;">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="header-breakFast breakfast mt-5">
                    <h1 class="text-right">BREAKFAST ?</h1>
                </div>
                <div class="content-breakFast breakfast mt-3">
                    <p style="font-size: 15px; line-height: 30px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, 
                        when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
                <div class="bottom-breakFast mt-5">
                    <h3 style="width: 70%;">Bread with eggs or bread with blueberries</h3>
                    <p class="mt-3" style="font-size: 15px; line-height: 30px; width: 65%;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, 
                        when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
                <div class="privateDining2-bottom">
                    <a href="/menu" class="btn btn-orange text-white mt-3">See More</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="orange-horizontal">
                    <div class="row">
                        <div class="left-img">
                            <img src="{{asset('img')}}/breakfast1.jpg" alt="">
                        </div>
                        <div class="right-img">
                            <img src="{{asset('img')}}/breakfast2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6 edit-privateDining-2">
                        <img src="{{asset('img')}}/private-dining-2.jpg" alt="">
                    </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6 edit-privateDining-2">
                        <img src="{{asset('img')}}/private-dining-4.jpg" alt="">
                    </div>
                    <div class="col-md-6 d-flex justify-content-center align-items-center flex-column">
                        <div class="header-privateDining-2">
