...
// const NameFood = ["Linguine Alle Vongole", "Chicken Saltimbocca", "Shrimp Fra Diavolo", "Bouillabasse", "Fettuccine Alfredo"];
// const ImgFood = ["Linguine-alle-vongole.jpg", "chicken-saltimbocca.jpg", "Shrimp-Fra-Diavolo.jpg", "Bouillabasse.jpg", "fettuccine-alfredo.jpg"];
// const HargaFood = ["64", "77", "72", "66", "69", "57"];
...
// while(cekValue){
//     if(noName == 5 && noImg == 5 && noHarga == 5){
//         cekValue == false
//         break
//     } else {
//         let setCard = CardFood(NameFood[noName], ImgFood[noImg], HargaFood[noHarga])
...
//                 let setCard = CardFood(NameFood[IndexSlide], ImgFood[IndexSlide], HargaFood[IndexSlide])
