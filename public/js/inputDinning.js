                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                               document.location.href = '/order';
                                                ...
                                                const CircleTow = document.querySelector(".barTwo");
                                                const CheckTwo = document.querySelector(".circle-2");
                                                const iconTableTwo = document.querySelector('.fa-credit-card');

                                                CircleTow.style.background = " #2dce89";
                                                CheckTwo.style.display = "block";
                                                CheckTwo.style.color = "white";
                                                iconTableTwo.style.display = "none";
                                            }
                                        })
                                    },
                                })
